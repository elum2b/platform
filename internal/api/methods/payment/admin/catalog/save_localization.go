...
type SaveLocalizationRequest struct {
	...
	Locale          string `json:"locale"           query:"locale"           validate:"required,max=255"`
	LocalizationKey string `json:"localization_key" query:"localization_key" validate:"required,max=255"`
...
var SaveLocalization = adapter.Method[SaveLocalizationRequest, struct{}]{
	...
	Middleware: []adapter.Middleware{
		adapter.WorkspaceAccess(saveLocalizationKey),
	},
