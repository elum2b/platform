...
func Register(registry adapter.Registry) {
	...
	tgroup.Get.Register(admin)
	tgroup.List.Register(admin)
	tgroup.Delete.Register(admin)
	tgrouplocalization.Upsert.Register(admin)
	tgrouplocalization.Get.Register(admin)
	tgrouplocalization.List.Register(admin)
	tgrouplocalization.Delete.Register(admin)
	tsequence.Upsert.Register(admin)
	tsequence.Get.Register(admin)
	tsequence.List.Register(admin)
	tsequence.Delete.Register(admin)
	treward.Upsert.Register(admin)
	treward.Get.Register(admin)
	treward.List.Register(admin)
	treward.Delete.Register(admin)
	tcondition.Upsert.Register(admin)
	tcondition.Get.Register(admin)
	tcondition.Delete.Register(admin)
	tcondition.List.Register(admin)
	ttasklocalization.Upsert.Register(admin)
	ttasklocalization.Get.Register(admin)
	ttasklocalization.List.Register(admin)
	ttasklocalization.Delete.Register(admin)
