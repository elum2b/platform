...
var (
	...
	CPAPostgresPassword = env.GetEnvString(
	...
	CPAPostgresDatabase = env.GetEnvString(
	...
	CPAMaxConnections = env.GetEnvInt(
		"CPA_MAX_CONNECTIONS",
	...
	CPAQueryTimeout = env.GetEnvDuration(
		"CPA_QUERY_TIMEOUT",
	...
	CPACacheL1Delay = env.GetEnvDuration(
		"CPA_CACHE_L1_DELAY",
	...
	CPACacheL2Delay = env.GetEnvDuration(
		"CPA_CACHE_L2_DELAY",
	...
	CPACacheTTLCheck = env.GetEnvDuration(
		"CPA_CACHE_TTL_CHECK",
