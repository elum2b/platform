...
var (
	...
	PaymentPostgresHost = env.GetEnvString(
	...
	PaymentPostgresUser = env.GetEnvString(
	...
	PaymentPostgresPassword = env.GetEnvString(
	...
	PaymentPostgresDatabase = env.GetEnvString(
