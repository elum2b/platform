...
var (
	...
	CalendarPostgresHost = env.GetEnvString(
		"CALENDAR_POSTGRES_HOST",
		PostgresHost,
	)
	...
	CalendarPostgresUser = env.GetEnvString(
	...
	CalendarPostgresPassword = env.GetEnvString(
	...
	CalendarPostgresDatabase = env.GetEnvString(
	...
	CalendarCacheTTLCheck = env.GetEnvDuration(
		"CALENDAR_CACHE_TTL_CHECK",
