...
var (
	...
	PromoPostgresPassword = env.GetEnvString(
	...
	PromoPostgresDatabase = env.GetEnvString(
	...
	PromoCacheTTLCheck = env.GetEnvDuration(
		"PROMO_CACHE_TTL_CHECK",
